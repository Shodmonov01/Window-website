...
import slider1 from "../../../assets/FrameSlider/frame (1).webp";
import slider2 from "../../../assets/FrameSlider/frame (2).webp";
import slider3 from "../../../assets/FrameSlider/frame (3).webp";
import slider4 from "../../../assets/FrameSlider/frame (4).webp";
import slider5 from "../../../assets/FrameSlider/frame (5).webp";
import slider6 from "../../../assets/FrameSlider/frame (6).webp";
import slider7 from "../../../assets/FrameSlider/frame (7).webp";
import slider8 from "../../../assets/FrameSlider/frame (8).webp";
import slider9 from "../../../assets/FrameSlider/frame (9).webp";
import slider10 from "../../../assets/FrameSlider/frame (10).webp";
import slider11 from "../../../assets/FrameSlider/frame (11).webp";
import slider12 from "../../../assets/FrameSlider/frame (12).webp";
            ...
            data.map((item, index) => (
              <SwiperSlide key={item.id} className=" lg:h-[600px] h-full">
                <div
                  ...
                  className="swiper-slide_1 w-[80%] lg:h-[544px] lg:w-[100%] ml-[38px] lg:ml-0"
                >
                  <img
                    src={item.imgSrc}
                    alt=""
                    className=" rounded-2xl h-[233px] lg:h-full object-cover"
                  />
                </div>
              </SwiperSlide>
            ))}
...
export default memo(SliderFrame);
