...
function Profil({ data }) {
  ...
  return (
    <div className="bg-box pt-[50px] lg:pt-[83px] pb-[100px] lg:pb-[40px]">
      <Layout>
        <div className="flex items-center justify-center">
          <span className="text-[23px] lg:text-[35px] xl:text-[50px] font-Montserrat bg_linear_gradient pb-[20px] lg:pb-[50px] font-bold">
            {data.header}
          </span>
        </div>
        ...
        <div className="relative">
                  ...
                  >
                    <div className="w-[278px] h-[348px] lg:col-span-1">
                      <img
                        src={item.img}
                        alt=""
                        className="w-[278px] h-[348px] object-cover"
                      />
                    </div>
          ...
          <div className="slide-nav top-[135px] flex items-center justify-between w-full z-[999] absolute px-[0px] bottom-[800px] lg:px-0 lg:top-0 lg:bottom-0 lg:left-0 lg:right-0">
            <img
