...
function Consultation() {
  ...
  return (
    <div className="py-[50px] lg:py-0 px-[10px] lg:px-0 lg:bg-transparent mt-[80px] lg:mt-[100px]">
      <div
        className="shadow-lg w-[96%] lg:w-[90%] m-auto pb-[80px] md:pb-93px pt-[40px] md:pt-[53px] rounded-md"
        data-aos="fade-up"
        data-aos-delay={500}
      >
        <h2 className="text-[23px] md:text-[38px]  -tracking-tighter uppercase font-bold text-center font-Montserrat ">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <input
              ...
              className="bg-[#E8E8ED33] px-6 h-[65px] border-black/5 rounded-md border focus:outline-none text-black"
              ref={name_ref}
              name="user_name"
              id="user_name_id"
              autoComplete="true"
            ...
            <div className="relative">
              ...
              <p className="absolute text-[10px] left-0 md:max-w-[400px] w-full mt-3">
